...
public class PostController {
    ...
    @GetMapping("/{postId}")
    public ResponseEntity<PostOneResponse> getOnePost(@PathVariable Long postId) {
    ...
    @GetMapping("/recent")
    public ResponseEntity<Page<RecentPostResponse>> getAllPosts(Pageable pageable, @RequestParam String categoryName){
        return ResponseEntity.ok(postService.getRecentPost(pageable, categoryName));
    }
    ...
    @PostMapping
    public ResponseEntity<PostCreateResponse> createPost(@ModelAttribute PostRequest request){
    ...
    @PatchMapping
    public ResponseEntity<PostUpdateResponse> updatePost(@ModelAttribute PostUpdateRequest request) {
    ...
    public ResponseEntity<LikeResponse> likePost(@PathVariable Long postId){
        return ResponseEntity.ok(new LikeResponse(postService.likePost(postId)));
    }
    ...
    public ResponseEntity<ScrapResponse> scrapPost(@PathVariable Long postId) {
        return ResponseEntity.ok(new ScrapResponse(postService.scrapPost(postId)));
    }
